...
// English1 [ 'Luzia', 'Kiana', 'Benedetto', 'Günther' ]
// English2 [ 'Wibke', 'Jeannette', 'Paul' ]
...
//    dies sicher!
console.log("-".repeat(20))
console.log(english1.sort())
console.log(english2.sort())
...
// 
console.log(english1.splice(0,0,"Anton"))
console.log(english1)
