...
let amountStr = "15,37";
let amount = parseFloat(amountStr.replace(",", ".")) * 100;  // 1537

console.log(" - " + Math.floor(amount / 200) + "x 2€")
amount = amount - Math.floor(amount / 200) * 200             // 137

console.log(" - " +Math.floor(amount / 100) + "x 1€")
amount = amount - Math.floor(amount / 100) * 100             // 37

console.log(" - " + Math.floor(amount / 50) + "x 50cent") 
amount = amount - Math.floor(amount / 50) * 50 

console.log(" - " + Math.floor(amount / 20) + "x 20cent") 
amount = amount - Math.floor(amount / 20) * 20 

console.log(" - " + Math.floor(amount / 10) + "x 10cent") 
amount = amount - Math.floor(amount / 10) * 10 

console.log(" - " + Math.floor(amount / 5) + "x 5cent") 
amount = amount - Math.floor(amount / 5) * 5 

console.log(" - " + Math.floor(amount / 2) + "x 2cent") 
amount = amount - Math.floor(amount / 2) * 2

console.log(" - " + Math.floor(amount / 1) + "x 1cent") 
...
let geld = 10 
let gesamtGeld =  Math.d(geld * 1.1 / 2.5) * 2.5 

console.log("Der Gesamtbetrag beträgt " + gesamtGeld.toFixed(2) + " $")